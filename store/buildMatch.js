...
function getMatch(db, redis, match_id, options, cb)
{
    ...
    function getPlayerMatchData(match_id, cb)
    {
        ...
        else
        {
            ...
            .orderBy("player_slot", "asc").asCallback(cb);
        }
    }
}
